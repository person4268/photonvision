...
public class AprilTagPipelineSettings extends AdvancedPipelineSettings {
    ...
    public int hashCode() {
        ...
        result = prime * result + (int) (Double.doubleToLongBits(minTagArea) ^ (Double.doubleToLongBits(minTagArea) >>> 32));
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Double.doubleToLongBits(minTagArea) != Double.doubleToLongBits(other.minTagArea)) return false;
        return true;
    }
}
